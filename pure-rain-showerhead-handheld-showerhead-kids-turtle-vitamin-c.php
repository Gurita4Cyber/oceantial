    ...
    <section class="w-full pb-20 pt-20 lg:px-20 relative">
        <div class="container px-5 pt-20 mx-auto flex sm:flex-nowrap flex-wrap">
            <div class="lg:w-2/3 rounded-lg overflow-hidden flex items-end justify-start relative">
                <div class="relative">
                    <img src="img/Showerhead-Turtle/showerheadturtle.jpeg" alt="Pure Rain - Showerhead Handheld - Showerhead Kids Turtle Vitamin C">
                </div>
            </div>
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full">
                <div class="pb-8">
                    ...
                    <h1 class="text-2xl font-bold pb-4 capitalize">Pure Rain - Showerhead Handheld - Showerhead Kids Turtle Vitamin C</h1>
                ...
                <section class="accordion bg-btnbg text-white my-0 mx-auto inline-flex items-center justify-center w-full">
                    <div class="tab w-full">
                        ...
                        <div class="tab__content">
                            ...
                            <a class="flex p-4" href="https://shopee.co.id/Aroma-Sense-AS-Kids-Turtle-Small-Handheld-Aromatherapy-and-Vitamin-C-Shower-Head-i.193319332.5504425533?sp_atk=0fa17bc3-60e3-4a5c-80bf-e8f52ef47b01
                            ">
                                <div class="iconbuy mr-3"><img src="img/icon/shopee.png" alt=""></div>
                                Shop via Shopee
                            </a>
                            <a class="flex p-4" href="https://www.tokopedia.com/oceantial/showerhead-aromatherapy-vitamin-c-aroma-sense-turtle?extParam=src%3Dshop">
                ...
                <div class="lg:w-1/2 lg:pr-4 w-full">
                    <ul>
                        ...
                        <li class="pb-6 flex">
                            ...
                            <div class="">:</div>
                            <div class="w-full">&nbsp;No. PR-KIDS (Turtle)</div>
                        </li>
                        <li class="pb-6 flex">
                            <div class="w-32">Color</div>
                            <div class="">:</div>
                            <div class="w-full">&nbsp;Green, Brown</div>
                        </li>
                        <li class="pb-6 flex">
                ...
                <div class="lg:w-1/2 lg:pl-4 w-full">
                    <ul>
                        <li class="pb-6 pt-6 flex">
                            ...
                            <div class="">:</div>
                            <div class="w-full">&nbsp;W 8.0cm x L 8.0cm x H 27.5cm</div>
                        </li>
                        <li class="pb-6 flex">
