        ...
        <div class="container px-5 pt-20 mx-auto flex sm:flex-nowrap flex-wrap">
            ...
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full">
                <div class="pb-8">
                    ...
                    <h1 class="text-2xl font-bold pb-4 capitalize">Aromica - Showerhead Handheld - Luxe Chrome</h1>
                ...
                <section class="accordion bg-btnbg text-white my-0 mx-auto inline-flex items-center justify-center w-full">
                    <div class="tab w-full">
                        ...
                        <div class="tab__content">
                            ...
                            <a class="flex p-4" href="https://shopee.co.id/Aromica-Luxe-Chrome-i.193319332.24224427125?sp_atk=6bcf60cf-3e47-4f28-9aaf-84d21bf63154&xptdk=6bcf60cf-3e47-4f28-9aaf-84d21bf63154
                            ">
                                <div class="iconbuy mr-3"><img src="img/icon/shopee.png" alt=""></div>
                                Shop via Shopee
                            </a>
                            <a class="flex p-4" href="https://tokopedia.link/Aj3Sl4fChLb">
                ...
                <div class="lg:w-1/2 lg:pr-4 w-full">
                    <ul>
                        ...
                        <li class="pb-6 flex">
                            ...
                            <div class="">:</div>
                            <div class="w-full">&nbsp;ARO-Luxe-Chrome</div>
                        </li>
                        <li class="pb-6 flex">
