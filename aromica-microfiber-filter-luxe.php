    ...
    <section class="w-full pb-20 pt-20 lg:px-20 relative">
        <div class="container px-5 pt-20 mx-auto flex sm:flex-nowrap flex-wrap">
            <div class="lg:w-2/3 rounded-lg overflow-hidden flex items-end justify-start relative">
                <div class="relative">
                    <img src="img/Aromica---Microfiber-Filter-Luxe.jpg" alt="Aromica - Microfiber Filter Luxe">
                    <img class="absolute top-0 left-0 w-20 border border-btnbg rounded-md" src="img/Aromica---Microfiber-Filter-Luxe.jpg" alt="Aromica - Microfiber Filter Luxe">
                </div>
            </div>
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full">
                <div class="pb-8">
                    ...
                    <h1 class="text-2xl font-bold pb-4 capitalize">Aromica - Microfiber Filter Luxe</h1>
                ...
                <p class="pb-4">Each microfiber pack comes in a set of 5.</p>
                ...
                <section class="accordion bg-btnbg text-white my-0 mx-auto inline-flex items-center justify-center w-full">
                    <div class="tab w-full">
                        ...
                        <div class="tab__content">
                            ...
                            <a class="flex p-4" href="https://www.tokopedia.com/oceantial/aromica-microfabric-filter-luxe-5-pcs?extParam=src%3Dshop%26whid%3D7243527">
