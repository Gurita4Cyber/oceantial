        ...
        <div class="container px-5 pt-20 mx-auto flex sm:flex-nowrap flex-wrap">
            <div class="lg:w-2/3 rounded-lg overflow-hidden flex items-end justify-start relative">
                <div class="relative">
                    ...
                    <img class="absolute top-0 left-0 w-20 border border-btnbg rounded-md" src="img/Aroma-Sense---Spare-parts---Anti-bakteri-AS9000-Medium-.jpg" alt="Aroma Sense - Spare parts - Anti bakteri AS9000 Medium">
                </div>
            </div>
