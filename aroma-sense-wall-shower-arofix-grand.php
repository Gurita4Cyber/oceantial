    ...
    <section class="w-full pb-20 pt-20 lg:px-20 relative">
        <div class="container px-5 pt-20 mx-auto flex sm:flex-nowrap flex-wrap">
            <div class="lg:w-2/3 rounded-lg overflow-hidden flex items-end justify-start relative">
                <div class="relative">
                    <img src="img/Arofix-Grand.jpg" alt="Aroma Sense - Wall Shower - Arofix Grand">
                    <img class="absolute top-0 left-0 w-20 border border-btnbg rounded-md" src="img/Arofix-Grand.jpg" alt="Aroma Sense - Wall Shower - Arofix Grand">
                </div>
            </div>
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full">
                <div class="pb-8">
                    ...
                    <h1 class="text-2xl font-bold pb-4 capitalize">Aroma Sense - Wall Shower - Arofix Grand</h1>
                ...
                <section class="accordion bg-btnbg text-white my-0 mx-auto inline-flex items-center justify-center w-full">
                    <div class="tab w-full">
                        ...
                        <div class="tab__content">
                            ...
                            <a class="flex p-4" href="https://shopee.co.id/Aroma-Sense-Arofix-Grand-Aromatherapy-and-Vitamin-C-Shower-head-i.193319332.8047252125?sp_atk=81f8c929-6ecf-4833-a593-c800751005a0
                            ">
                                <div class="iconbuy mr-3"><img src="img/icon/shopee.png" alt=""></div>
                                Shop via Shopee
                            </a>
                            <a class="flex p-4" href="https://tokopedia.link/bEkk4h0AhLb">
                ...
                <div class="lg:w-1/2 lg:pr-4 w-full">
                    <ul>
                        ...
                        <li class="pb-6 flex">
                            ...
                            <div class="">:</div>
                            <div class="w-full">&nbsp;AROFIX-GRAND FULL SET</div>
                        </li>
                        <li class="pb-6 flex">
                            <div class="w-32">Color</div>
                            <div class="">:</div>
                            <div class="w-full">&nbsp;White, Silver</div>
                        </li>
                        <li class="pb-6 flex">
                ...
                <div class="lg:w-1/2 lg:pl-4 w-full">
                    <ul>
                        <li class="pb-6 pt-6 flex">
                            ...
                            <div class="">:</div>
                            <div class="w-full">&nbsp;W 30cm x L 20cm x H 5.0cm</div>
                        </li>
                        <li class="pb-6 flex">
