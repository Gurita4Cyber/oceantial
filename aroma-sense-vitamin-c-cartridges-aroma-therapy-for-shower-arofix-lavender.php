        ...
        <div class="container px-5 pt-20 mx-auto flex sm:flex-nowrap flex-wrap">
            ...
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full">
                <div class="pb-8">
                    ...
                    <h1 class="text-2xl font-bold pb-4 capitalize">Aroma Sense - Vitamin C Cartridges Aroma Therapy for Shower Arofix - Lavender</h1>
                ...
                <p class="pb-4">Embrace the calming, restorative powers of lavender with the AROFIX filter. This innovative solution not only eliminates chlorine from your water, but it also infuses it with a refreshing, aromatherapeutic scent to alleviate anxiety, improve sleep, and boost circulation. Enriched with a concentrated dose of vitamin C, the AROFIX filter nourishes hair and skin for an all-encompassing wellness experience. Enjoy up to 9,000 liters of purified, rejuvenating water per cartridge.</p>
