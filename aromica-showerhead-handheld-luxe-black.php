    ...
    <section class="w-full pb-20 pt-20 lg:px-20 relative">
        <div class="container px-5 pt-20 mx-auto flex sm:flex-nowrap flex-wrap">
            <div class="lg:w-2/3 rounded-lg overflow-hidden flex items-end justify-start relative">
                <div class="relative">
                    <img src="img/LUXE-Black.jpg" alt="Aromica - Showerhead Handheld - Luxe Black">
                    <img class="absolute top-0 left-0 w-20 border border-btnbg rounded-md" src="img/LUXE-Black.jpg" alt="Aromica - Showerhead Handheld - Luxe Black">
                </div>
            </div>
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full">
                <div class="pb-8">
                    <div class="inline-flex items-center gap-1 pb-4">
                        <h2 class="text-title2 text-lg font-semibold">Aromica
                        </h2>
                    ...
                    <h1 class="text-2xl font-bold pb-4 capitalize">Aromica - Showerhead Handheld - Luxe Black</h1>
                ...
                <section class="accordion bg-btnbg text-white my-0 mx-auto inline-flex items-center justify-center w-full">
                    <div class="tab w-full">
                        ...
                        <div class="tab__content">
                            ...
                            <a class="flex p-4" href="https://shopee.co.id/Aromica-Luxe-Black-Edition-i.193319332.25674424034?sp_atk=13cfba6d-1d47-436e-8432-77816e35c456&xptdk=13cfba6d-1d47-436e-8432-77816e35c456
                            ">
                                <div class="iconbuy mr-3"><img src="img/icon/shopee.png" alt=""></div>
                                Shop via Shopee
                            </a>
                            <a class="flex p-4" href="https://tokopedia.link/3p3JyMpChLb">
                ...
                <div class="lg:w-1/2 lg:pr-4 w-full">
                    <ul>
                        ...
                        <li class="pb-6 flex">
                            ...
                            <div class="">:</div>
                            <div class="w-full">&nbsp;ARO-Luxe-Black</div>
                        </li>
                        <li class="pb-6 flex">
                ...
                <div class="lg:w-1/2 lg:pl-4 w-full">
                    <ul>
                        ...
                        <li class="pb-6 flex">
                            ...
                            <div class="">:</div>
                            <div class="w-full">&nbsp;10 cm</div>
                        </li>
                        <li class="pb-6 flex">
                            <div class="w-32">Height</div>
                            <div class="">:</div>
                            <div class="w-full">&nbsp;- g</div>
                        </li>
