    ...
    <section class="w-full pb-20 pt-20 lg:px-20 relative">
        <div class="container px-5 pt-20 mx-auto flex sm:flex-nowrap flex-wrap">
            <div class="lg:w-2/3 rounded-lg overflow-hidden flex items-end justify-start relative">
                <div class="relative">
                    <img src="img/CARTRIDGES-JASMINE/jasmine-vitamin-c-cartridges.jpg" alt="Aroma Sense - Vitamin C Cartridges -  Jasmine">
                    <img class="absolute top-0 left-0 w-20 border border-btnbg rounded-md" src="img/CARTRIDGES-JASMINE/jasmine-vitamin-c-cartridges.jpg" alt="Aroma Sense - Vitamin C Cartridges -  Jasmine">
                </div>
            </div>
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full">
                <div class="pb-8">
                    ...
                    <h1 class="text-2xl font-bold pb-4 capitalize">Aroma Sense - Vitamin C Cartridges -  Jasmine</h1>
                ...
                <p class="pb-4">Immerse yourself in the elegant, calming embrace of the Jasmine, a soothing hydration companion that helps alleviate stress with each refined, aromatic drop.</p>
                ...
                <section class="accordion bg-btnbg text-white my-0 mx-auto inline-flex items-center justify-center w-full">
                    <div class="tab w-full">
                        ...
                        <div class="tab__content">
                            ...
                            <a class="flex p-4" href="https://www.tokopedia.com/oceantial/aromatherapy-vitamin-c-aroma-sense-jasmine-1pcs?extParam=src%3Dshop%26whid%3D7243527">
