    ...
    <section class="w-full pb-20 pt-20 lg:px-20 relative">
        <div class="container px-5 pt-20 mx-auto flex sm:flex-nowrap flex-wrap">
            <div class="lg:w-2/3 rounded-lg overflow-hidden flex items-end justify-start relative">
                <div class="relative">
                    <img src="img/Neutral.jpg" alt="Aroma Sense - Vitamin C Cartridges - Neutral">
                    <img class="absolute top-0 left-0 w-20 border border-btnbg rounded-md" src="img/Neutral.jpg" alt="Aroma Sense - Vitamin C Cartridges - Neutral">
                </div>
            </div>
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full">
                <div class="pb-8">
                    ...
                    <h1 class="text-2xl font-bold pb-4 capitalize">Aroma Sense - Vitamin C Cartridges - Neutral</h1>
                ...
                <div class="price pb-8">
                    <h2 class="font-semibold text-2xl">IDR 150,000</h2>
                </div>
                <p class="pb-4">For those seeking a gentle, unscented shower experience, the Neutral Filter delivers a nourishing cleanse infused with the skin-reviving benefits of vitamin C, providing a refreshing, allergy-friendly hydration solution.</p>
                ...
                <section class="accordion bg-btnbg text-white my-0 mx-auto inline-flex items-center justify-center w-full">
                    <div class="tab w-full">
                        ...
                        <div class="tab__content">
                            ...
                            <a class="flex p-4" href="https://shopee.co.id/Aroma-Sense-Handheld-Vitamin-C-Cartridges-%E2%80%93-Neutral-i.193319332.7804427499?sp_atk=dbfed1bc-1710-4316-8129-e120ba6620d5
                            ">
                                <div class="iconbuy mr-3"><img src="img/icon/shopee.png" alt=""></div>
                                Shop via Shopee
                            </a>
                            <a class="flex p-4" href="https://www.tokopedia.com/oceantial/aromatherapy-vitamin-c-aroma-sense-neutral-1pcs?extParam=src%3Dshop">
