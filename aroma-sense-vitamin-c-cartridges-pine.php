        ...
        <div class="container px-5 pt-20 mx-auto flex sm:flex-nowrap flex-wrap">
            <div class="lg:w-2/3 rounded-lg overflow-hidden flex items-end justify-start relative">
                <div class="relative">
                    ...
                    <img class="absolute top-0 left-0 w-20 border border-btnbg rounded-md" src="img/CARTRIDGES-PINE/pine3in1abcd.jpg" alt="Aroma Sense - Vitamin C Cartridges -  Pine">
                </div>
            </div>
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full">
                <div class="pb-8">
                    ...
                    <h1 class="text-2xl font-bold pb-4 capitalize">Aroma Sense - Vitamin C Cartridges - Pine</h1>
                ...
                <p class="pb-4">Awaken your focus and clarity with the invigorating aroma of the Pine Filter, designed to help sharpen the mind and boost concentration with each refreshing drop.</p>
                ...
                <section class="accordion bg-btnbg text-white my-0 mx-auto inline-flex items-center justify-center w-full">
                    <div class="tab w-full">
                        ...
                        <div class="tab__content">
                            ...
                            <a class="flex p-4" href="https://shopee.co.id/Aroma-Sense-Handheld-Vitamin-C-Cartridges-%E2%80%93-Pine-i.193319332.3719087084?sp_atk=5f57b1a9-1fe1-4c68-b5ef-80fd0398bf16
                            ">
                                <div class="iconbuy mr-3"><img src="img/icon/shopee.png" alt=""></div>
                                Shop via Shopee
                            </a>
                            <a class="flex p-4" href="https://www.tokopedia.com/oceantial/aromatherapy-vitamin-c-aroma-sense-pine-1pcs?extParam=src%3Dshop">
