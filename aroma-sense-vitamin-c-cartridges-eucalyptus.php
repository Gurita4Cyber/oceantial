        ...
        <div class="container px-5 pt-20 mx-auto flex sm:flex-nowrap flex-wrap">
            <div class="lg:w-2/3 rounded-lg overflow-hidden flex items-end justify-start relative">
                <div class="relative">
                    ...
                    <img class="absolute top-0 left-0 w-20 border border-btnbg rounded-md" src="img/CARTRIDGES-EUCALYPTUS/eucalyptus-vitamin-c-cartridge4.jpg" alt="Aroma Sense - Vitamin C Cartridges -  Eucalyptus">
                </div>
            </div>
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full">
                <div class="pb-8">
                    ...
                    <h1 class="text-2xl font-bold pb-4 capitalize">Aroma Sense - Vitamin C Cartridges -  Eucalyptus</h1>
                ...
                <p class="pb-4">Harness the revitalizing power of eucalyptus to help combat fatigue, ease discomfort, and elevate your senses with a gentle, aromatic infusion.</p>
                ...
                <section class="accordion bg-btnbg text-white my-0 mx-auto inline-flex items-center justify-center w-full">
                    <div class="tab w-full">
                        ...
                        <div class="tab__content">
                            ...
                            <a class="flex p-4" href="https://shopee.co.id/Aroma-Sense-Handheld-Vitamin-C-Cartridges-%E2%80%93-Eucalyptus-i.193319332.6118991702?sp_atk=bbf5c078-5fec-45be-9f1f-86d5a9d20085
                            ">
