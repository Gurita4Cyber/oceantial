    ...
    <section class="w-full pb-20 pt-20 lg:px-20 relative">
        <div class="container px-5 pt-20 mx-auto flex sm:flex-nowrap flex-wrap">
            <div class="lg:w-2/3 rounded-lg overflow-hidden flex items-end justify-start relative">
                <div class="relative">
                    <img src="img/Showerhead-Mist.jpg" alt="Aroma Sense - Showerhead Handheld - Mist Vitamin C">
                </div>
            </div>
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full">
                <div class="pb-8">
                    ...
                    <h1 class="text-2xl font-bold pb-4 capitalize">Aroma Sense - Showerhead Handheld - Mist Vitamin C</h1>
                    <div class="flex">
                        <!-- rating -->
                ...
                <p class="pb-4">Showerhead Aroma Sense Mist Vitamin C memberikan pengalaman mandi yang multifungsi dan menyegarkan. Dilengkapi dengan dua mode, yaitu semprotan biasa dan semprotan mist, produk ini memberikan efek aromaterapi menggunakan minyak aromatik alami untuk meningkatkan relaksasi dan mengurangi stres. Semprotan mist secara lembut dan efektif membersihkan kulit, memberikan pengalaman layaknya di spa.</p>
                <p class="pb-4">Showerhead ini menetralisir klorin pada air yang belum tersaring, memperkaya kulit dan rambut dengan vitamin C, serta mengoptimalkan tekanan air dengan menghemat penggunaan air hingga 30%. Filter microfiber pada produk ini juga menyaring sisa-sisa karat, kotoran, dan kontaminan. Selain itu, Aroma Sense Showerhead Mist Vitamin C menghasilkan hingga empat kali lipat jumlah ion negatif, yang secara ilmiah terbukti membantu pernapasan, meningkatkan aliran darah, dan mengurangi stres.</p>
                <section class="accordion bg-btnbg text-white my-0 mx-auto inline-flex items-center justify-center w-full">
                    <div class="tab w-full">
                        ...
                        <div class="tab__content">
                            ...
                            <a class="flex p-4" href="https://s.shopee.co.id/700F52Fbyf">
                ...
                <div class="lg:w-1/2 lg:pl-4 w-full">
                    <ul>
                        <li class="pb-6 pt-6 flex">
                            ...
                            <div class="">:</div>
                            <div class="w-full">&nbsp;W 8.0 cm x L 8.7 cm x H 27.0 cm</div>
                        </li>
                        <li class="pb-6 flex">
