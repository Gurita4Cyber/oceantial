    ...
    <section class="w-full pb-20 pt-20 lg:px-20 relative">
        <div class="container px-5 pt-20 mx-auto flex sm:flex-nowrap flex-wrap">
            <div class="lg:w-2/3 rounded-lg overflow-hidden flex items-end justify-start relative">
                <div class="relative">
                    <img src="img/Refill-PR-303/c1a682797965284fe0f1e4481997dd0d.jpeg" alt="Pure Rain - Microfiber Tap Water Filter PR303 (Kitchen)">
                </div>
            </div>
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full">
                <div class="pb-8">
                    ...
                    <h1 class="text-2xl font-bold pb-4 capitalize">Pure Rain - Microfiber Tap Water Filter PR303 (Kitchen)</h1>
                    <div class="flex">
                        <!-- rating -->
                ...
                <p class="pb-4">Filter ini secara efektif menyingkirkan klorin, karat, dan kontaminan lainnya dari air keran, pelat semprot segitiga berpaten kami memastikan aliran air bertekanan tinggi yang hemat air dengan ion negatif. Desain transparan memungkinkan Anda dengan mudah memantau penggunaan filter, yang dapat bertahan hingga 2.000 liter pemakaian.</p>
                <p class="pb-4">Dengan desain sederhana namun elegan, nikmati air bersih dan murni langsung dari keran Anda. Tingkatkan kualitas air dan rasakan perbedaannya dalam setiap tetes.</p>
                <section class="accordion bg-btnbg text-white my-0 mx-auto inline-flex items-center justify-center w-full">
                    <div class="tab w-full">
                        ...
                        <div class="tab__content">
                            ...
                            <a class="flex p-4" href="https://s.shopee.co.id/AKGh779koj">
                ...
                <div class="lg:w-1/2 lg:pr-4 w-full">
                    <ul>
                        <li class="pb-6 pt-6 flex">
                            ...
                            <div class="">:</div>
                            <div class="w-full">&nbsp;Pure Rain Sink head</div>
                        </li>
                        <li class="pb-6 flex">
                            <div class="w-32">Model</div>
                            <div class="">:</div>
                            <div class="w-full">&nbsp;No. PR-303</div>
                        </li>
                        <li class="pb-6 flex">
                        ...
                        <li class="pb-6 flex">
                            ...
                            <div class="">:</div>
                            <div class="w-full">&nbsp;Vitamin C filter, Micro fabric filter</div>
                        </li>
                    </ul>
                </div>
                <div class="lg:w-1/2 lg:pl-4 w-full">
                    <ul>
                        <li class="pb-6 pt-6 flex">
                            ...
                            <div class="">:</div>
                            <div class="w-full">&nbsp;W 5.8cm x L 5.8cm x H 6.9cm</div>
                        </li>
                        <li class="pb-6 flex">
                            <div class="w-32">Head Diameter</div>
                            <div class="">:</div>
                            <div class="w-full">&nbsp;5cm</div>
                        </li>
                        <li class="pb-6 flex">
                            <div class="w-32">Height</div>
                            <div class="">:</div>
                            <div class="w-full">&nbsp;129.5g</div>
                        </li>
