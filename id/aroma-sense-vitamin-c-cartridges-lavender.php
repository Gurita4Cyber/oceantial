        ...
        <div class="container px-5 pt-20 mx-auto flex sm:flex-nowrap flex-wrap">
            ...
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full">
                <div class="pb-8">
                    ...
                    <h1 class="text-2xl font-bold pb-4 capitalize">Aroma Sense - vitamin c cartidges lavender</h1>
                    <div class="flex">
                        <!-- rating -->
                ...
                <p class="pb-4">Nikmati pengalaman hidrasi dengan sentuhan aroma lavender yang membantu meningkatkan kualitas tidur dan membuat kulit Anda tampak lebih cerah. Filter ini menghadirkan aroma bunga yang menciptakan sebuah oasis ketenangan agar Anda dapat me-recharge kembali tubuh.</p>
