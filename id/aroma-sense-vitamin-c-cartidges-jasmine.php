        ...
        <div class="container px-5 pt-20 mx-auto flex sm:flex-nowrap flex-wrap">
            ...
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full">
                <div class="pb-8">
                    ...
                    <h1 class="text-2xl font-bold pb-4 capitalize">Aroma Sense - vitamin c cartidges jasmine</h1>
                    <div class="flex">
                        <!-- rating -->
                ...
                <p class="pb-4">Rasakan pelukan yang menenangkan dan elegan dari aroma melati. Filter ini menjadi pendamping hidrasi yang menyegarkan, membantu mengusir stres dengan setiap tetes airnya yang dipenuhi kelembutan aroma melati.</p>
