    ...
    <section class="w-full pb-20 pt-20 lg:px-20 relative">
        <div class="container px-5 pt-20 mx-auto flex sm:flex-nowrap flex-wrap">
            ...
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full">
                ...
                <p class="pb-4">Tambahkan sentuhan lemon ke dalam air untuk merasakan kekuatan pemurnian. Lemon tidak hanya membantu mendetoksifikasi kulit, tapi juga dapat meningkatkan fokus dan menghidupkan seluruh indera Anda dengan aroma yang menyegarkan.</p>
