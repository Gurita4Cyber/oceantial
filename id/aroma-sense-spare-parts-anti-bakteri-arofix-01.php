    ...
    <section class="w-full pb-20 pt-20 lg:px-20 relative">
        <div class="container px-5 pt-20 mx-auto flex sm:flex-nowrap flex-wrap">
            ...
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full">
                ...
                <p class="pb-4">Jaga kinerja showerhead Aroma Sense tetap optimal dengan menggunakan butiran keramik antibakteri kami! Butiran ini secara efektif menyerap partikel kimia dan kontaminan yang mungkin terdapat dalam pasokan air, memastikan air yang keluar dari showerhead Anda bersih dan sehat.</p>
