        ...
        <div class="container px-5 pt-20 mx-auto flex sm:flex-nowrap flex-wrap">
            ...
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full">
                <div class="pb-8">
                    ...
                    <h1 class="text-2xl font-bold pb-4 capitalize">Aroma Sense - showerhead handheld showerhead 801</h1>
                    <div class="flex">
                        <!-- rating -->
                ...
                <section class="accordion bg-btnbg text-white my-0 mx-auto inline-flex items-center justify-center w-full">
                    <div class="tab w-full">
                        ...
                        <div class="tab__content">
                            ...
                            <a class="flex p-4" href="https://tokopedia.link/lmqmKQfBhLb">
                ...
                <div class="lg:w-1/2 lg:pr-4 w-full">
                    <ul>
                        ...
                        <li class="pb-6 flex">
                            ...
                            <div class="">:</div>
                            <div class="w-full">&nbsp;No. AS-801</div>
                        </li>
                        <li class="pb-6 flex">
                ...
                <div class="lg:w-1/2 lg:pl-4 w-full">
                    <ul>
                        <li class="pb-6 pt-6 flex">
                            ...
                            <div class="">:</div>
                            <div class="w-full">&nbsp;W 8.6 cm x L 6.5 cm x H 27.0 cm</div>
                        </li>
                        <li class="pb-6 flex">
                            <div class="w-32">Diameter</div>
                            <div class="">:</div>
                            <div class="w-full">&nbsp;8.6 cm</div>
                        </li>
                        <li class="pb-6 flex">
                            <div class="w-32">Height</div>
                            <div class="">:</div>
                            <div class="w-full">&nbsp;349 g</div>
                        </li>
