    ...
    <section class="w-full pb-20 pt-20 lg:px-20 relative">
        <div class="container px-5 pt-20 mx-auto flex sm:flex-nowrap flex-wrap">
            ...
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full">
                ...
                <p class="pb-4">Nikmati pengalaman mandi dengan aroma bunga mawar yang mempercantik diri. Biarkan kelembutan aroma bunga mawar meresapi setiap tetes air, membantu meningkatkan suasana hati dan menjadikan kulit lebih berseri.</p>
