    ...
    <section class="w-full pb-20 pt-20 lg:px-20 relative">
        <div class="container px-5 pt-20 mx-auto flex sm:flex-nowrap flex-wrap">
            <div class="lg:w-2/3 rounded-lg overflow-hidden flex items-end justify-start relative">
                <div class="relative">
                    <img src="img/Showerhead-Shark-Pink/shark.png" alt="Pure Rain - Showerhead Handheld - Showerhead Kids Shark Pink Vitamin C">
                </div>
            </div>
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full">
                <div class="pb-8">
                    ...
                    <h1 class="text-2xl font-bold pb-4 capitalize">Pure Rain - Showerhead Handheld - Showerhead Kids Shark Pink Vitamin C</h1>
                    <div class="flex">
                        <!-- rating -->
                ...
                <div class="lg:w-1/2 lg:pr-4 w-full">
                    <ul>
                        ...
                        <li class="pb-6 flex">
                            ...
                            <div class="">:</div>
                            <div class="w-full">&nbsp;No. PR-KIDS (Shark Pink)</div>
                        </li>
                        <li class="pb-6 flex">
                            <div class="w-32">Color</div>
                            <div class="">:</div>
                            <div class="w-full">&nbsp;White, Pink</div>
                        </li>
                        <li class="pb-6 flex">
